...
public class TelegramMessagePackage<TItem> : ITelegramMessagePackage<TItem>
{
    ...
    public required string MessageType { get; set; } = "AF"; // Always set to 'AF' when coming from the API
    ...
    public string FileType { get; } = typeof(TItem) == typeof(BatchMessage) ? "Batch" : "Campaign";
}
